...
Please not that This patched version only supports iPhone3,1 restores to ios 6.1.6. For downgrades to other ios versions, please use Legacy-iOS-Kit instead.
